    ...
    <main className={classNames("wrapper", styles.container)}>
      <div className={styles.content}>
        <div className={"self-center flex flex-col"}>
          <PageTitle title={"About company"} subTitle={""} />
          <div className={"flex self-center gap-10 md:w-[70%] sm:w-full"}>
            <div
              className={
                "flex flex-col justify-between flex-1 space-y-3 gap-10"
              }
            >
              <div className={"space-y-3"}>
                ...
                <p className={"text-typeGray text-center"}>
                  Effortless elegance in every mile. Glide through your travels
                  with ease and style. Choose from our curated fleet of
                  vehicles, each meticulously maintained for your comfort and
                  safety. Embrace the freedom of the open road while we handle
                  the details. Your journey, your way, with CarRental.
                </p>
              </div>
        ...
        <div className={"self-center flex flex-col"}>
          <PageTitle title={"Discover Seamless Mobility"} subTitle={""} />
        </div>
      </div>
    </main>
  );
